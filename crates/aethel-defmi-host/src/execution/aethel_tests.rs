...
fn avalanche_state_executes_guaranteed_receivable_issue_default_and_claim() {
    ...
    let credential_request = CredentialRequest {
        ...
        holder_public_key: subject.holder_public_key(),
        holder_suite: subject.holder_suite(),
        scope_digest: id(53),
        policy_digest: id(47),
    ...
    let membership_request = CredentialRequest {
        ...
        holder_public_key: member_witness.holder_public_key(),
        holder_suite: member_witness.holder_suite(),
